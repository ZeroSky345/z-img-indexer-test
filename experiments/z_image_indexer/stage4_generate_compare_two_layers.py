...
def parse_args():
    ...
    parser.add_argument("--indexer-ckpts", type=str, required=True, help="Comma-separated ckpt paths aligned with layer-ids")
    ...
    def sparse_model_fn(
        ...
        **kwargs,
        ...
        if dit.siglip_embedder is not None:
            raise NotImplementedError("Stage4 script currently supports Z-Image-Turbo style path only.")
...
def main():
    ...
    for idx, prompt in enumerate(prompts):
        ...
        save_comparison_grid(
            ...
            sparse_image,
            "dense",
            f"sparse layers={','.join(map(str, layer_ids))} topk={args.topk}",
            grid_path,
        )
