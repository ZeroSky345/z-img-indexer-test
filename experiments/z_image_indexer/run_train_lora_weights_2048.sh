...
# Train LoRA adapter weights only. The base Z-Image-Turbo DiT weights stay frozen.
# The resulting checkpoint can be used as TEACHER_LORA_PATH for indexer distillation.
...
OUTPUT_PATH="${OUTPUT_PATH:-./models/lora/z_image_turbo_lora_2048}"
