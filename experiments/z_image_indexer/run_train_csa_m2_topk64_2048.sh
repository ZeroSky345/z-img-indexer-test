...
# High-resolution single-layer CSA-style indexer distillation.
# Use this after the 512x512 single-layer run has passed.
...
python experiments/z_image_indexer/train_csa_indexer.py \
  ...
  --output-dir experiments/z_image_indexer/results/train_csa_layer12_m2_topk64_2048 \
  --steps 1000 \
  --height 2048 \
  --width 2048 \
