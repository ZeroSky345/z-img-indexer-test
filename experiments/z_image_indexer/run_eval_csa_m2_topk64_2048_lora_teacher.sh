...
# Evaluate single-layer CSA indexer replacement using the selected/trained LoRA weight.
# weight for both dense and sparse generation.
...
INDEXER_CKPT=${INDEXER_CKPT:-experiments/z_image_indexer/results/train_csa_layer12_m2_topk64_2048_lora_teacher/csa_indexer_distill.pt}
...
python experiments/z_image_indexer/eval_csa_indexer.py \
  ...
  --output-dir experiments/z_image_indexer/results/eval_csa_layer12_m2_topk64_2048_lora_teacher \
  --height 2048 \
  --width 2048 \
